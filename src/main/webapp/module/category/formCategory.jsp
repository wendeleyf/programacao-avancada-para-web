...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <form:form action="/category" method="POST" modelAttribute="categoryForm" >
           ...
           <spring:bind path="description">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="description" class="form-control" placeholder="Descrição da categoria"
                                autofocus="true"></form:input>
